          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Icon(icon, color: AppColors.chambray, size: 20),
              ),
              // Large chambray value
              Text(
                value,
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              value: progressValue,
              minHeight: 20,
              backgroundColor: AppColors.espresso.withOpacity(0.12),
              valueColor:
                  const AlwaysStoppedAnimation<Color>(AppColors.chambray),
            ),
          ),
          const SizedBox(height: 12),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            const Icon(Icons.arrow_back, color: AppColors.chambray, size: 18),
            const SizedBox(width: 8),
            Text(
