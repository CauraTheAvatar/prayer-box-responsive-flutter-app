          ...
          children: [
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                border: Border(
                  bottom: BorderSide(color: AppColors.chambray, width: 1),
                ),
              ),
              child: Column(
            ...
            const Padding(
              ...
              child: Divider(color: AppColors.chambray, thickness: 0.8),
            ),
  ...
  Widget _navButton({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(icon, color: AppColors.chambray, size: 20),
      ...
      child: Row(
        children: [
          Icon(
            ...
            color: isActive
                ? AppColors.espresso
                : AppColors.espresso.withOpacity(0.4),
            size: 20,
          ),
